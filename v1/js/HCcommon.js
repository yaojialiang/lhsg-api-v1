...
HCEPG.UI = {
     ...
     * @param dir：滑动方向
     */
    scroll:function(view,scroll,nextBtn,dir){
        if(view && scroll && nextBtn && dir){
            ...
            if(
                ...
                nextBtn[offset2Attr] ) - (this.getTarDomOffset(scroll,view,offset1Attr)*-1 + view[offset2Attr])) + 'px';
            }
            else if(this.getTarDomOffset(nextBtn,scroll,offset1Attr)  < this.getTarDomOffset(scroll,view,offset1Attr)*-1  ){
                scroll.style[styleAttr] = this.getTarDomOffset(scroll,view,offset1Attr) + (this.getTarDomOffset(scroll,view,offset1Attr)*-1 -  this.getTarDomOffset(nextBtn,scroll,offset1Attr) ) + "px";
            }
        }
    },
    /**
